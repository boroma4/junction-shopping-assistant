...
export const PRODUCTS = [
    ...
    {id:8,description:"A sub-normal plastic cup.", name: "Almost plastic cup", brandName:"Dini",pic:Cup, price:8, cat: 'Misc' , cap: 1, type:'plcup', isEco:true},

    {id:9,description:"Pleb toothbrush!", name: "Bad toothbrush", brandName:"Cowgate",pic:Toothbrush, price:2, cat: 'Bathroom' , cap: 90, type:'tbrush'},
    {id:10,description:"Standard toothbrush!", name: "Average toothbrush", brandName:"Corngate",pic:Toothbrush, price:5, cat: 'Bathroom' , cap: 90, type:'tbrush'},
    ...
    {id:12,description:"Pleb toothpaste!", name: "Toothpasty (400ml)", brandName:"Anyway",pic:Toothpaste, price:4, cat: 'Bathroom' , cap: 60, type:'tpaste500'},
    {id:13,description:"Standard toothpaste!", name: "Toothpasta (400ml)", brandName:"Acid",pic:Toothpaste, price:10, cat: 'Bathroom' , cap: 60, type:'tpaste500', isEco:true},
    ...
    {id:18,description:"Very normal.", name: "Trashbags with holes (50l)", brandName:"Bibi",pic:Trash, price:1, cat: 'Misc' , cap: 120, type:'trash50'},
    ...
    {id:21,description:"I think it only got worse.", name: "Smelly toilet tablets (5pcs)", brandName:"Bibi",pic:Pods, price:1, cat: 'Toilet' , cap: 180, type:'tablets5'},
    ...
    {id:23,description:"Have you tried the shampoo from that hotel already?", name: "Perfect toilet tablets (5pcs)", brandName:"Stolen from a well-known hotel",pic:Pods, price:100, cat: 'Toilet' , cap: 180, type:'tablets5'},
];
